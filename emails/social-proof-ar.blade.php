@php
    ...
    $dashboardUrl = $dashboardUrl ?? route('landing', ['ref' => 'email_sales_story_ar']);
    $offerBadgeImageUrl = "https://s3.us-east-1.amazonaws.com/bostenenglishcenter.com-bucket/slider/emails/offer-badge-square.png";
    $emailPreviewText = 'سارة كانت خائفة من التحدث. بعد 3 أشهر حصلت على ترقية. تغيير ما حدث.';
@endphp
<!DOCTYPE html>
...
<head>
    ...
    <title>Boston English Center - نتائج حقيقية</title>
    ...
    <style>
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .before-after-left { background: #151F4B !important; }
            .before-after-right { background: #123c2e !important; }
    ...
    <tr>
        <td align="center" style="padding: 24px 10px 40px;">
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="container" style="max-width:680px; background:#FBFBFF; border-radius:20px; overflow:hidden;">
                ...
                <tr>
                    <td class="pad" style="padding-top:10px; padding-bottom:24px;">
                        <h1 class="hero-title text-dark" style="margin:0 0 14px; font-size:34px; line-height:40px; font-weight:900; color:#061538;">
                            كانت خائفة من التحدث.<br>بعد 3 أشهر، حصلت على <span class="purple">ترقية.</span>
                        </h1>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="pad" style="padding-bottom:24px;">
                        <div style="border-radius:16px; overflow:hidden;">
                            <img src="https://s3.us-east-1.amazonaws.com/bostenenglishcenter.com-bucket/landing-page/img/imagine.webp?v=1.1" width="624" alt="امرأة تتحدث الإنجليزية بثقة" style="width:100%; max-width:100%; height:auto; display:block;">
                        </div>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td style="padding:28px 26px;">
                                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:16px;">
                                        <tr>
                                            <td valign="middle">
                                                <div style="width:48px; height:48px; border-radius:50%; background:#E8F5E9; color:#16A34A; font-size:16px; font-weight:900; text-align:center; line-height:48px;">س</div>
                                            </td>
                                            <td valign="middle" style="padding-right:14px;">
                                                <div class="text-dark" style="font-size:16px; font-weight:900; color:#061538;">سارة من كندا</div>
                                                <div class="stars" style="font-size:14px;">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
                                            </td>
                                        </tr>
                                    </table>
                                    <div class="story-text" style="font-size:16px; line-height:25px; color:#221A4B;">
                                        "كنت أعرف الإنجليزية. كنت أملك القواعد. لكن في كل مرة كان علي التحدث في اجتماع، <strong>كنت أتجمد.</strong> شاهدت زملاء بمهارات أضعف يتقدمون لأنهم يستطيعون التواصل بشكل أفضل."
                                    </div>
                                    <div class="story-text" style="font-size:16px; line-height:25px; color:#221A4B; margin-top:14px;">
                                        "ثم انضممت إلى Boston English Center. غرف المحادثة أجبرتني على <strong>استخدام</strong> الإنجليزية فعلياً،不仅仅是 دراستها. بعد 3 أشهر، قادت أول عرض تقديمي بالإنجليزية. الأسبوع الماضي حصلت على الترقية التي أردتها."
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td width="48%" class="before-after-left" style="background:#FFF5F5; border-radius:14px; padding:18px 16px;">
                                    <div style="font-size:11px; font-weight:800; text-transform:uppercase; color:#DC2626; margin-bottom:8px;">&#10060; قبل</div>
                                    <div style="font-size:14px; line-height:21px; color:#7F1D1D;">خائفة من التحدث في الاجتماعات. شاهدت الآخرين يتقدمون.</div>
                                </td>
                                <td width="4%"></td>
                                <td width="48%" class="before-after-right" style="background:#F0FDF4; border-radius:14px; padding:18px 16px;">
                                    <div style="font-size:11px; font-weight:800; text-transform:uppercase; color:#16A34A; margin-bottom:8px;">&#10003; بعد 3 أشهر</div>
                                    <div style="font-size:14px; line-height:21px; color:#14532D;">قادت عروض تقديمية بالإنجليزية. حصلت على ترقية.</div>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td class="pad" style="padding-bottom:24px;">
                        <div style="font-size:16px; font-weight:800; color:#061538; margin-bottom:12px;">ليست وحدها.</div>
                        <div style="font-size:14px; line-height:24px; color:#4E5A73;">
                            <strong style="color:#061538;">أكثر من 25,000 طالب</strong> من أكثر من 80 دولة غيّروا إنجليزيتهم بالفعل.<br>
                            <span class="stars" style="font-size:14px;">&#9733;&#9733;&#9733;&#9733;&#9733;</span> <strong style="color:#061538;">4.9 من 5</strong> &middot; 3,237 مراجعة موثقة
                        </div>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td align="center" style="padding:16px 20px;">
                                    <div style="font-size:15px; font-weight:900; color:#DC2626;">
                                        &#9200; خصم 50% الخاص بك في انتظارك.
                                    </div>
                                    <div style="font-size:14px; color:#7F1D1D; margin-top:4px;">
                                        لكن ليس إلى الأبد. السعر سيعود إلى $70/شهرياً قريباً.
                                    </div>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td align="center" style="padding:24px;">
                                    <div style="margin-bottom:12px;">
                                        <img src="{{ $offerBadgeImageUrl }}" width="90" height="90" alt="خصم 50%" style="width:90px; height:90px; display:inline-block;">
                                    </div>
                ...
                <tr>
                    <td class="pad" style="padding-bottom:12px; text-align:center;">
                        ...
                        <div class="text-muted" style="font-size:12px; color:#7B849A; margin-top:10px;">
                            إلغاء في أي وقت. لا رسوم خفية. ابدأ التحدث هذا الأسبوع.
                        </div>
                    </td>
                </tr>
