                                ...
                                <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        ...
                                        <td style="padding-right:12px; padding-left:0; vertical-align:top;">
                                            <div class="story-name">سارة، كندا</div>
                                ...
                                <tr>
                                    <td class="col-half" width="48%" style="vertical-align:top;">
                                        <div class="card-danger">
                                            ...
                                            <div class="card-text-danger">تجنبت محادثات الإنجليزية. تجمدت في الاجتماعات. شاهدت الآخرين يحصلون على ترقيات.</div>
                                        </div>
                                    </td>
                                    <td width="4%"></td>
                                    <td class="col-half" width="48%" style="vertical-align:top;">
                                        <div class="card-success">
                                            ...
                                            <div class="card-text-success">أقود الاجتماعات. أتحدث بثقة. حصلت على ترقية خلال 6 أشهر.</div>
                                        </div>
                                    </td>
                                </tr>
                            </table>
