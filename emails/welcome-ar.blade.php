                    ...
                    <tr>
                        <td class="pad" style="padding-top:28px;">
                            <div class="left-accent">
                                ...
                                <p> خلال 6 أشهر، إما أن تتحدث الإنجليزية في الاجتماعات والمقابلات والمحادثات — أو ستظل تقول "سأبدأ الأسبوع القادم". الفرق ليس الموهبة. إنه القرار الذي تتخذه الآن.</p>
                            </div>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td class="col-half" width="48%" style="vertical-align:top;">
                                        <div class="card-danger">
                                            ...
                                            <div class="card-label-danger">إذا انتظرت</div>
                                            <div class="card-text-danger">نفس الخوف. نفس الصمت. نفس النتائج.</div>
                                        </div>
                                    </td>
                                    <td width="4%"></td>
                                    <td class="col-half" width="48%" style="vertical-align:top;">
                                        <div class="card-success">
                                            <div style="font-size:24px; margin-bottom:6px;">&#10003;</div>
                                            <div class="card-label-success">إذا بدأت اليوم</div>
                                            <div class="card-text-success">ثقة. فرص. أنت الجديد.</div>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td class="pad" style="padding-top:28px; padding-bottom:28px;">
                            <p class="body-text" style="text-align:center; margin:0;">
                                <strong class="proof-bold">+25,000</strong> طالب من <strong class="proof-bold">+80 دولة</strong> اتخذوا هذا القرار. لم ينتظروا اللحظة المثالية. بل بدؤوا.
                            </p>
                        </td>
                    </tr>
                    <tr>
