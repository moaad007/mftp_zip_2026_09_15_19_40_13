...
<head>
    ...
    <style>
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .email-footer-end, .brand-footer { background: #071636 !important; }
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="container" style="width:100%; max-width:740px; background:#FBFBFF; border:0; border-top:0; border-bottom:0; outline:0; box-shadow:none; border-collapse:collapse; border-spacing:0;">
                ...
                <tr>
                    <td class="email-footer-end" style="padding:0; background:#FBFBFF;">
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td align="center" style="padding:24px 18px 28px; background:#FBFBFF;">
                                    <div class="text-main footer-title" style="font-size:22px; line-height:24px; font-weight:900; color:#071A44; letter-spacing:-0.6px;">Boston <span style="color:#7B4DFF;">English</span> Center</div>
                                    <div class="text-muted footer-copy" style="margin:10px 0 0; font-size:13px; line-height:20px; color:#64748B; text-align:center;">
                                        Questions? Call <a href="tel:16178482317" style="color:#7B4DFF; font-weight:700;">+1 (617) 848-2317</a> or email <a href="mailto:{{ $supportEmail }}" style="color:#7B4DFF; font-weight:700;">{{ $supportEmail }}</a>
                                    </div>
                                    <div class="text-muted footer-copy" style="margin:12px 0 0; font-size:11px; line-height:18px; color:#9CA3AF; text-align:center;">
