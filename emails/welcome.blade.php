                        ...
                        <td class="pad" style="padding-top:28px;">
                            <div class="left-accent">
                                ...
                                <p style="font-size:15px; line-height:24px; color:#061538; margin:0;">
                                    In 6 months, you'll either be speaking English in meetings, interviews, and conversations — or you'll still be saying "I'll start next week." The difference isn't talent. It's the decision you make right now.
                                </p>
                            </div>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td width="48%" style="vertical-align:top; padding-right:8px;">
                                        <div style="background:#FEF2F2; border-radius:8px; padding:16px; text-align:center;">
                                            ...
                                            <div style="font-size:12px; font-weight:800; color:#DC2626; text-transform:uppercase; letter-spacing:0.5px;">If you wait</div>
                                            <div style="font-size:13px; color:#7F1D1D; margin-top:6px; line-height:18px;">Same fear. Same silence. Same results.</div>
                                        </div>
                                    </td>
                                    <td width="4%"></td>
                                    <td width="48%" style="vertical-align:top; padding-left:8px;">
                                        <div style="background:#F0FDF4; border-radius:8px; padding:16px; text-align:center;">
                                            <div style="font-size:24px; margin-bottom:6px;">&#10003;</div>
                                            <div style="font-size:12px; font-weight:800; color:#16A34A; text-transform:uppercase; letter-spacing:0.5px;">If you start</div>
                                            <div style="font-size:13px; color:#14532D; margin-top:6px; line-height:18px;">Confidence. Opportunities. A new you.</div>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td class="pad" style="padding-top:28px; padding-bottom:28px;">
                            <p class="body-text" style="text-align:center; margin:0;">
                                <strong style="color:#061538;">25,000+</strong> students from <strong style="color:#061538;">80+ countries</strong> made this choice. They didn't wait for the perfect moment. They started.
                            </p>
                        </td>
                    </tr>
